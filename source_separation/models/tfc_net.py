...
from source_separation.models.building_blocks import TFC
...
class TFC_NET(Dense_UNET):
    ...
    def __init__(self,
        ...
        def mk_tfc(in_channels, internal_channels, f):
            return TFC(in_channels, n_internal_layers, internal_channels, kernel_size_t, kernel_size_f, tfc_activation)
...
class TFC_NET_Framework(Dense_UNET_Framework):
    ...
    def __init__(self, target_name,
        ...
        valid_kwargs = inspect.signature(TFC_NET_Framework.__init__).parameters
